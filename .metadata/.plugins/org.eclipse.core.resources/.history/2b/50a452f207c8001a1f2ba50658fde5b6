...
public class Ex5 {
	...
	public static void main(String[] args) {
		...
		// =>a 값을 1만큼 증가시키는 다른 방법 : a = a + 1 or a +=1
		a++;
		System.out.println(a);
		--a;
		System.out.println(a);
		...
		//먼저 x의 값을 변수 y2에 대입한 뒤 x2의 값을 1만큼 증가시킴
		//따라서 x2가 5일때 y2에 저장되고
		//그 후 x2의 값이 5->6으로 증가
		System.out.println(x2+","+y2);
		
		int i = 5;
		int j = ++i; 
		//선행연산자이므로 i값을 증가시킨 후 j에 저장(i = 6, j = 6)
		System.out.println(j++);
		//후행연산자이므로 j값을 출력한 후, 1 증가시킴
		//(6이 출력된 후 j 값은 6->7로 증가됨)
		System.out.println(--i);
		//선행연산자이므로 j값을 1 감소시킨 후 출력
		//(j 값은 7->6으로 감소된 후 6이 출력됨)
		
		System.out.println("<--------------------------->");
		
		char ch = 'A';
		ch = ch+=1;//별도의 형변환 필요없음
		//확장대입연산자
