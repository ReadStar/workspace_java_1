...
public class Ex8 {
	...
	public static void main(String[] args) {
		...
		public static void score(int score) throws Exception {
			//int형 파라미터에 정수 150이 전달될 경우 문법적으로는 맞지만
...
//					//=>try~catch 를 통해 예외를 처리 or  throws를 통해 예외 위임
//				} catch (Exception e) {
...
//				}
		...
		public static void score2(int score) throws InvalidScoreException {
			//사용자 정이ㅡ 예외 클래스를 사용하여 강제로 예외 발생 시키기
			if(score<0||score>100) {
...
/*
* 사용자 정의 예외 클래스
* -기존에 자바 API 에서 제공되는 예외가 아닌
* 	개발자가 직접 예외 클래스를 작성하는 경우
* 	Exception 클래스를 통해 상속받는 클래스를 정의하여 예외 관련 코드를 기술
*/
class InvalidScoreException extends Exception{
	//1. 생성자를 정의하여 예외 메세지를 전달받을 수 있는
	//	   String타입 파라미터 1개를 갖는 메서드 오버라이딩
