...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   Matcher 클래스는 정규표현식 내용이 포함되는지 여부와 위치 등 좀 더 복잡한 판별을 수행 가능
		 *   
		 */
		
		String sourceStr = "Java and Javascript has no relation";
		String regex = "Java";
		//Pattern.compile() 메서드는 정규 표현식을 갖는 Pattern 객체 리턴
		...
		//2. lookingAt()메서드 : 정규표현식 문자열로 시작하는지 검사
		...
		//4. replaceFirst() : 정규표현식에 일치하는 첫 문자열을 치환
