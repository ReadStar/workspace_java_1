...
public class Ex4 {
	...
	public static void main(String[] args) {
		/*
		 * 생성자 this()
		 * -생성자 내에서 자신의 인스턴스 내의 다른 대상자를 호출
...
//		age = 0;
		...
		//=>생성자는 new 이외에 직접 호출이 불가능 하며 생성자 this() 필수
		this("홍길동", 0);
	}
...
//   		age = 0;
			...
			System.out.println("Person4(String)생성자 호출");
		}
		//이름, 나이 전달받는 생성자 정의
	public Person4(String name, int age) {
		this.name = name;
		this.age = age;
		System.out.println("Person4(String, int)생성자 호출");
	}
	}