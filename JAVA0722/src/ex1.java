...
public class ex1 {
	...
	public static void main(String[] args) {
		...
		int num = 10;
		if (num > 15) {// 조건식 : 변수 num이 5보다 클 경우 true, 아니면 false
					//조건식 판별 결과가 true일 때 실행할 문장
			System.out.println("num은 5보다 크다"); //문장2
		...
		num = 3;
		boolean b = true;
		//boolean타입 변수 또는 리터럴을 if문에 직접 전달 가능
		if(b) {//조건식 : 변수 num이 5보다 크면 true, 아니면 false
			//조건식 판별 결과가 true일 때 실행할 문장
