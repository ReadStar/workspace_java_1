public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * 상속에서의 생성자
		 * -생성자는 상속되지 않는다.
		 * 	=>생성자의 이름은 자신의 클래스 이름과 동일해야 하므로
		 * 		부모의 생속자를 상속받으려면 클래스 이름과 다르기 때문
...
//		 SpiderMan s2 = new SpiderMan("피터 파커", 20);
	}
...
class Person {
	//=> Person클래스는 별도의 상속이 표시되지 않았으므로
	// 		자동으로 Object 클래스를 상속받는다
	String name;
	int age;
	public Person() {
		//Object클래스의 기본 생성자 Object()가 자동으로 먼저 호출됨
